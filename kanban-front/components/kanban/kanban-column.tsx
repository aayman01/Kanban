        ...
        {canEdit ? (
          adding ? (
            ...
            <button
              ...
              className="w-full rounded-lg border border-dashed border-border bg-transparent px-3 py-2.5 text-left text-[13px] text-muted-foreground hover:border-white/20 hover:bg-white/[0.03] hover:text-foreground"
            >
              + Add a card
            </button>
          )
